...
(function () {
    ...
    var pathRoot = "js/webgl-inspector/";

    var useDebug = window["gliEmbedDebug"];
    var afterInspectorLoad = window["afterInspectorLoad"];
    ...
    for (var n = 0; n < scripts.length; n++) {
        ...
        if (/webgl\-inspector\/embed.js$/.test(src)) {
    ...
    if (useDebug) {
        ...
        var script = insertScript(jsurl);
        script.onload = afterInspectorLoad;
    }
